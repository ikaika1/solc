...
export module Logger {
  ...
  export const solvAA = () => {
    ...
    console.log(`${row5}`)
    console.log(`${row6}\n`)
    console.log(`Solc Version: v${VERSION}\n`)
  }

  export const installMessage = () => {
    const msg = warningHex(`🔥 Welcome to Solana Validator Tool Solc 🔥`)
    const msg2 = `
Solc is born and ready for running Solana Validator 🚀

$ cd ~ && source ~/.profile
$ solc setup

$ solc --help for more information
`
    console.log(msg)
  ...
  export const installClientMessage = () => {
    const msg = warningHex(`🔥 Welcome to Solana Validator Tool Solc 🔥`)
    const msg2 = `
This is solc CLI mode for Solana Validator Management ⭐️
