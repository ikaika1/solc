...
// This will overwrite the solc.service file with the new configuration to easily switch between testnet and mainnet
export function setupSolvService(isTest = true): void {
  ...
  console.log('solc.service configuration created.')
}
