const configToml = () => {
  const filePath = '/home/solc/firedancer/config.toml'
...
[log]
    path = \"/home/solc/solana-validator.log\"
    colorize = \"auto\"
    level_logfile = \"INFO\"
    level_stderr = \"NOTICE\"
    level_flush = \"WARNING\"
...
[consensus]
    identity_path = \"/home/solc/identity.json\"
    vote_account_path = \"/home/solc/testnet-vote-account-keypair.json\"
